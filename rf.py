...
class RandomForestClassifier(object):
    ...
    def fit(self, dataset, targets):
        ...
        # 并行建立多棵决策树
        self.trees = joblib.Parallel(n_jobs=-1, verbose=0, backend="threading")(
...
if __name__ == '__main__':
    ...
    feature_list = ["classification", "nose_x", "nose_y", "neck_x", "neck_y", "Rshoulder_x", "Rshoulder_y",
                    ...
                    "LAnkle_x",	"LAnkle_y", "REye_x", "REye_y",	"LEye_x", "LEye_y", "REar_x", "REar_y",
                    "LEar_x", "Lear_y",	"weight", "sumtimes", "alarmtimes", "label"
                    ]
